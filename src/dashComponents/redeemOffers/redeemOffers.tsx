...
export const RedeemOffers = () => {
    ...
    const { redeemOffers, loading }= useGetRedeemOffers()
    const inputs = [
      {
        type : "date",
        name : "start_Date",
  ...
  return <DisplayOffers data={data} setData={setData} handleChange={handleChange} id="redeem" inputs={inputs} offersData={redeemOffers} loading={loading}/>
}
